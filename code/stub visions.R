### Q46
"Status"
employ_datQ46<-multidatClean(Q46, Academic, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q46 + Academic, data = employ_datQ46)
conTable
detach(dat_long)
#employ_datQ46<-NotsureordinaldatClean(employ_datQ46$Q46, employ_datQ46)
#ordinal(employ_datQ46$CatOutcome, employ_datQ46$Academic, employ_datQ46)
##prep <- analysisPrep(employ_datQ46$CatOutcome, employ_datQ46$Academic, employ_datQ46)
##analysis <- polr(employ_datQ46$CatOutcome ~ employ_datQ46$Academic, data=employ_datQ46, Hess=TRUE)
...
"College"
employ_datQ46College<-multidatClean(Q46, Q3, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q46 + Q3, data = employ_datQ46College)
conTable
detach(dat_long)
#employ_datQ46College$Q3[(employ_datQ46College$Q3 == "Research Professional Staff")]="Other"
#employ_datQ46College$Q3<- factor(employ_datQ46College$Q3)
#employ_datQ46College<-NotsureordinaldatClean(employ_datQ46College$Q46, employ_datQ46College)
#ordinal(employ_datQ46College$CatOutcome, employ_datQ46College$Q3, employ_datQ46College)
#prep <- analysisPrep(employ_datQ46College$CatOutcome, employ_datQ46College$Q3, employ_datQ46College)
#analysis <- polr(employ_datQ46College$CatOutcome ~ employ_datQ46College$Q3, data=employ_datQ46College, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
employ_datQ46Carer<-multidatClean(Q46, Carer, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q46 + Carer, data = employ_datQ46Carer)
conTable
detach(dat_long)
#employ_datQ46Carer$Carer<- factor(employ_datQ46Carer$Carer)
#employ_datQ46Carer<-NotsureordinaldatClean(employ_datQ46Carer$Q46, employ_datQ46Carer)
#ordinal(employ_datQ46Carer$CatOutcome, employ_datQ46Carer$Carer, employ_datQ46Carer)
#prep <- analysisPrep(employ_datQ46Carer$CatOutcome, employ_datQ46Carer$Carer, employ_datQ46Carer)
#analysis <- polr(employ_datQ46Carer$CatOutcome ~ employ_datQ46Carer$Carer, data=employ_datQ46Carer, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Disability"
employ_datQ46Disability<-multidatClean(Q46, Disability, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q46 + Disability, data = employ_datQ46Disability)
conTable
detach(dat_long)
#employ_datQ46Disability$Disability<- factor(employ_datQ46Disability$Disability)
#employ_datQ46Disability<-NotsureordinaldatClean(employ_datQ46Disability$Q46, employ_datQ46Disability)
#conTable <- xtabs(~Q46 + Disability, data = employ_datQ46Disability)
#ordinal(employ_datQ46Disability$CatOutcome, employ_datQ46Disability$Disability, employ_datQ46Disability)
#prep <- analysisPrep(employ_datQ46Disability$CatOutcome, employ_datQ46Disability$Disability, employ_datQ46Disability)
#analysis <- polr(employ_datQ46Disability$CatOutcome ~ employ_datQ46Disability$Disability, data=employ_datQ46Disability, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Ethnicity"
employ_datQ46Ethnicity<-multidatClean(Q46, EthnicityCleaned, UniqueResponseNumber, employ_dat)
detach(dat_long)
#employ_datQ46Ethnicity$Ethnicity<- factor(employ_datQ46Ethnicity$EthnicityCleaned)
#employ_datQ46Ethnicity<-NotsureordinaldatClean(employ_datQ46Ethnicity$Q46, employ_datQ46Ethnicity)
conTable <- xtabs(~Q46 + EthnicityCleaned, data = employ_datQ46Ethnicity)
conTable
#ordinal(employ_datQ46Ethnicity$CatOutcome, employ_datQ46Ethnicity$EthnicityCleaned, employ_datQ46Ethnicity)
#prep <- analysisPrep(employ_datQ46Ethnicity$CatOutcome, employ_datQ46Ethnicity$EthnicityCleaned, employ_datQ46Ethnicity)
#analysis <- polr(employ_datQ46Ethnicity$CatOutcome ~ employ_datQ46Ethnicity$EthnicityCleaned, data=employ_datQ46Ethnicity, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
employ_datQ46FirstGen<-multidatClean(Q46, FirstGen, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q46 + FirstGen, data = employ_datQ46FirstGen)
conTable
detach(dat_long)
#employ_datQ46FirstGen$FirstGen<-factor(employ_datQ46FirstGen$FirstGen)
#employ_datQ46FirstGen<-NotsureordinaldatClean(employ_datQ46FirstGen$Q46, employ_datQ46FirstGen)
#ordinal(employ_datQ46FirstGen$CatOutcome, employ_datQ46FirstGen$FirstGen, employ_datQ46FirstGen)
#prep <- analysisPrep(employ_datQ46FirstGen$CatOutcome, employ_datQ46FirstGen$FirstGen, employ_datQ46FirstGen)
#analysis <- polr(employ_datQ46FirstGen$CatOutcome ~ employ_datQ46FirstGen$FirstGen, data=employ_datQ46FirstGen, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Gender"
employ_datQ46Gender<-multidatClean(Q46, Gender, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q46 + Gender, data = employ_datQ46Gender)
conTable
#ordinal(employ_datQ46Gender$CatOutcome, employ_datQ46Gender$Gender, employ_datQ46Gender)
#prep <- analysisPrep(employ_datQ46Gender$CatOutcome, employ_datQ46Gender$Gender, employ_datQ46Gender)
#analysis <- polr(employ_datQ46Gender$CatOutcome ~ employ_datQ46Gender$Gender, data=employ_datQ46Gender, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Sexuality"
employ_datQ46Sexuality<-multidatClean(Q46, Sexuality, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q46 + Sexuality, data = employ_datQ46Sexuality)
conTable
#ordinal(employ_datQ46Sexuality$CatOutcome, employ_datQ46Sexuality$Sexuality, employ_datQ46Sexuality)
#prep <- analysisPrep(employ_datQ46Sexuality$CatOutcome, employ_datQ46Sexuality$Sexuality, employ_datQ46Sexuality)
#analysis <- polr(employ_datQ46Sexuality$CatOutcome ~ employ_datQ46Sexuality$Sexuality, data=employ_datQ46Sexuality, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
OR_Outcomes <- data.frame(Question, Dimension, OR[1,1], OR[1,2], OR[2,2])
colnames(new_OR_Outcomes) <-(c("Question", "Dimension", "OR", "l95", "u95"))
OR_Outcomes <- rbind(OR_Outcomes, new_OR_Outcomes) 
detach(data)
