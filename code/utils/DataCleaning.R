...
dat<- read.csv('code/data/results-for-university-of-2022-10-29-2056.csv', header = T, check.names = F)
...
dat2020<- read.csv("code/data/AnalysisSet2.csv", header = T, check.names = F) 
...
# Replace a problematic character with an acceptable replacement or an empty string
# Here, I'm replacing � with ' '

cleandat2020a_factor$Q2.a <- as.character(cleandat2020a_factor$Q2.a)
raw_bytes_list <- lapply(cleandat2020a_factor$Q2.a, charToRaw)
clean_vector <- ifelse(raw_bytes_list == 'a3', charToRaw(""), raw_bytes_list)
cleandat2020a_factor$Q2.a <- clean_vector
