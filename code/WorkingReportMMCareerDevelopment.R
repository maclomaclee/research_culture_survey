...
"Status"
employ_datQ23<-multidatClean(Q23, Academic, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23 + Academic, data = employ_datQ23)
conTable
detach(dat_long)
#employ_datQ23<-NotsureordinaldatClean(employ_datQ23$Q23, employ_datQ23)
#ordinal(employ_datQ23$CatOutcome, employ_datQ23$Academic, employ_datQ23)
##prep <- analysisPrep(employ_datQ23$CatOutcome, employ_datQ23$Academic, employ_datQ23)
##analysis <- polr(employ_datQ23$CatOutcome ~ employ_datQ23$Academic, data=employ_datQ23, Hess=TRUE)
...
"College"
employ_datQ23College<-multidatClean(Q23, Q3, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23 + Q3, data = employ_datQ23College)
conTable
detach(dat_long)
#employ_datQ23College$Q3[(employ_datQ23College$Q3 == "Research Professional Staff")]="Other"
#employ_datQ23College$Q3<- factor(employ_datQ23College$Q3)
#employ_datQ23College<-NotsureordinaldatClean(employ_datQ23College$Q23, employ_datQ23College)
#ordinal(employ_datQ23College$CatOutcome, employ_datQ23College$Q3, employ_datQ23College)
#prep <- analysisPrep(employ_datQ23College$CatOutcome, employ_datQ23College$Q3, employ_datQ23College)
#analysis <- polr(employ_datQ23College$CatOutcome ~ employ_datQ23College$Q3, data=employ_datQ23College, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#Question <-  "Q23"
#Dimension <- "College"
#new_#OR_Outcomes <- data.frame(Question, #Dimension, OR)
...
employ_datQ23Carer<-multidatClean(Q23, Carer, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23 + Carer, data = employ_datQ23Carer)
conTable
detach(dat_long)
#employ_datQ23Carer$Carer<- factor(employ_datQ23Carer$Carer)
#employ_datQ23Carer<-NotsureordinaldatClean(employ_datQ23Carer$Q23, employ_datQ23Carer)
#ordinal(employ_datQ23Carer$CatOutcome, employ_datQ23Carer$Carer, employ_datQ23Carer)
#prep <- analysisPrep(employ_datQ23Carer$CatOutcome, employ_datQ23Carer$Carer, employ_datQ23Carer)
#analysis <- polr(employ_datQ23Carer$CatOutcome ~ employ_datQ23Carer$Carer, data=employ_datQ23Carer, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#Question <-  "Q23"
#Dimension <- "Carer"
#new_#OR_Outcomes <- data.frame(Question, #Dimension, OR[1,1], OR[1,2], OR[2,2])
#colnames(new_OR_Outcomes) <-(c("Question", "#Dimension", "OR", "l95", "u95"))
#OR_Outcomes <- rbind(OR_Outcomes, new_OR_Outcomes)
#detach(data)
...
"Disability"
employ_datQ23Disability<-multidatClean(Q23, Disability, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23 + Disability, data = employ_datQ23Disability)
conTable
detach(dat_long)
#employ_datQ23Disability$Disability<- factor(employ_datQ23Disability$Disability)
#employ_datQ23Disability<-NotsureordinaldatClean(employ_datQ23Disability$Q23, employ_datQ23Disability)
#conTable <- xtabs(~Q23 + Disability, data = employ_datQ23Disability)
#ordinal(employ_datQ23Disability$CatOutcome, employ_datQ23Disability$Disability, employ_datQ23Disability)
#prep <- analysisPrep(employ_datQ23Disability$CatOutcome, employ_datQ23Disability$Disability, employ_datQ23Disability)
#analysis <- polr(employ_datQ23Disability$CatOutcome ~ employ_datQ23Disability$Disability, data=employ_datQ23Disability, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Ethnicity"
employ_datQ23Ethnicity<-multidatClean(Q23, EthnicityCleaned, UniqueResponseNumber, employ_dat)
detach(dat_long)
#employ_datQ23Ethnicity$Ethnicity<- factor(employ_datQ23Ethnicity$EthnicityCleaned)
#employ_datQ23Ethnicity<-NotsureordinaldatClean(employ_datQ23Ethnicity$Q23, employ_datQ23Ethnicity)
conTable <- xtabs(~Q23 + EthnicityCleaned, data = employ_datQ23Ethnicity)
conTable
#ordinal(employ_datQ23Ethnicity$CatOutcome, employ_datQ23Ethnicity$EthnicityCleaned, employ_datQ23Ethnicity)
#prep <- analysisPrep(employ_datQ23Ethnicity$CatOutcome, employ_datQ23Ethnicity$EthnicityCleaned, employ_datQ23Ethnicity)
#analysis <- polr(employ_datQ23Ethnicity$CatOutcome ~ employ_datQ23Ethnicity$EthnicityCleaned, data=employ_datQ23Ethnicity, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
employ_datQ23FirstGen<-multidatClean(Q23, FirstGen, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23 + FirstGen, data = employ_datQ23FirstGen)
conTable
detach(dat_long)
#employ_datQ23FirstGen$FirstGen<-factor(employ_datQ23FirstGen$FirstGen)
#employ_datQ23FirstGen<-NotsureordinaldatClean(employ_datQ23FirstGen$Q23, employ_datQ23FirstGen)
#ordinal(employ_datQ23FirstGen$CatOutcome, employ_datQ23FirstGen$FirstGen, employ_datQ23FirstGen)
#prep <- analysisPrep(employ_datQ23FirstGen$CatOutcome, employ_datQ23FirstGen$FirstGen, employ_datQ23FirstGen)
#analysis <- polr(employ_datQ23FirstGen$CatOutcome ~ employ_datQ23FirstGen$FirstGen, data=employ_datQ23FirstGen, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Gender"
employ_datQ23Gender<-multidatClean(Q23, Gender, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q23 + Gender, data = employ_datQ23Gender)
conTable
#ordinal(employ_datQ23Gender$CatOutcome, employ_datQ23Gender$Gender, employ_datQ23Gender)
#prep <- analysisPrep(employ_datQ23Gender$CatOutcome, employ_datQ23Gender$Gender, employ_datQ23Gender)
#analysis <- polr(employ_datQ23Gender$CatOutcome ~ employ_datQ23Gender$Gender, data=employ_datQ23Gender, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
"Sexuality"
employ_datQ23Sexuality<-multidatClean(Q23, Sexuality, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q23 + Sexuality, data = employ_datQ23Sexuality)
conTable
#ordinal(employ_datQ23Sexuality$CatOutcome, employ_datQ23Sexuality$Sexuality, employ_datQ23Sexuality)
#prep <- analysisPrep(employ_datQ23Sexuality$CatOutcome, employ_datQ23Sexuality$Sexuality, employ_datQ23Sexuality)
#analysis <- polr(employ_datQ23Sexuality$CatOutcome ~ employ_datQ23Sexuality$Sexuality, data=employ_datQ23Sexuality, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#Q23_OR_Table <- OR_Outcomes
#OR_Outcomes
#graph_prep (OR_Outcomes)

### Q23.a
"Status"
employ_datQ23.a<-multidatClean(Q23.a, Academic, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23.a + Academic, data = employ_datQ23.a)
conTable
detach(dat_long)
#employ_datQ23.a<-NotsureordinaldatClean(employ_datQ23.a$Q23.a, employ_datQ23.a)
#ordinal(employ_datQ23.a$CatOutcome, employ_datQ23.a$Academic, employ_datQ23.a)
##prep <- analysisPrep(employ_datQ23.a$CatOutcome, employ_datQ23.a$Academic, employ_datQ23.a)
##analysis <- polr(employ_datQ23.a$CatOutcome ~ employ_datQ23.a$Academic, data=employ_datQ23.a, Hess=TRUE)
##assumption<-brant(analysis)
##analysisSummary <- summary(analysis)
##ctable <- coef(summary(analysis))
##p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across College
"College"
employ_datQ23.aCollege<-multidatClean(Q23.a, Q3, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23.a + Q3, data = employ_datQ23.aCollege)
conTable
detach(dat_long)
#employ_datQ23.aCollege$Q3[(employ_datQ23.aCollege$Q3 == "Research Professional Staff")]="Other"
#employ_datQ23.aCollege$Q3<- factor(employ_datQ23.aCollege$Q3)
#employ_datQ23.aCollege<-NotsureordinaldatClean(employ_datQ23.aCollege$Q23.a, employ_datQ23.aCollege)
#ordinal(employ_datQ23.aCollege$CatOutcome, employ_datQ23.aCollege$Q3, employ_datQ23.aCollege)
#prep <- analysisPrep(employ_datQ23.aCollege$CatOutcome, employ_datQ23.aCollege$Q3, employ_datQ23.aCollege)
#analysis <- polr(employ_datQ23.aCollege$CatOutcome ~ employ_datQ23.aCollege$Q3, data=employ_datQ23.aCollege, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Carer- Yes/No
"Caring Responsibilities"
employ_datQ23.aCarer<-multidatClean(Q23.a, Carer, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23.a + Carer, data = employ_datQ23.aCarer)
conTable
detach(dat_long)
#employ_datQ23.aCarer$Carer<- factor(employ_datQ23.aCarer$Carer)
#employ_datQ23.aCarer<-NotsureordinaldatClean(employ_datQ23.aCarer$Q23.a, employ_datQ23.aCarer)
#ordinal(employ_datQ23.aCarer$CatOutcome, employ_datQ23.aCarer$Carer, employ_datQ23.aCarer)
#prep <- analysisPrep(employ_datQ23.aCarer$CatOutcome, employ_datQ23.aCarer$Carer, employ_datQ23.aCarer)
#analysis <- polr(employ_datQ23.aCarer$CatOutcome ~ employ_datQ23.aCarer$Carer, data=employ_datQ23.aCarer, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Disability
"Disability"
employ_datQ23.aDisability<-multidatClean(Q23.a, Disability, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23.a + Disability, data = employ_datQ23.aDisability)
conTable
detach(dat_long)
#employ_datQ23.aDisability$Disability<- factor(employ_datQ23.aDisability$Disability)
#employ_datQ23.aDisability<-NotsureordinaldatClean(employ_datQ23.aDisability$Q23.a, employ_datQ23.aDisability)
#conTable <- xtabs(~Q23.a + Disability, data = employ_datQ23.aDisability)
#ordinal(employ_datQ23.aDisability$CatOutcome, employ_datQ23.aDisability$Disability, employ_datQ23.aDisability)
#prep <- analysisPrep(employ_datQ23.aDisability$CatOutcome, employ_datQ23.aDisability$Disability, employ_datQ23.aDisability)
#analysis <- polr(employ_datQ23.aDisability$CatOutcome ~ employ_datQ23.aDisability$Disability, data=employ_datQ23.aDisability, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Ethnicity 
"Ethnicity"
employ_datQ23.aEthnicity<-multidatClean(Q23.a, EthnicityCleaned, UniqueResponseNumber, employ_dat)
detach(dat_long)
#employ_datQ23.aEthnicity$Ethnicity<- factor(employ_datQ23.aEthnicity$EthnicityCleaned)
#employ_datQ23.aEthnicity<-NotsureordinaldatClean(employ_datQ23.aEthnicity$Q23.a, employ_datQ23.aEthnicity)
conTable <- xtabs(~Q23.a + EthnicityCleaned, data = employ_datQ23.aEthnicity)
conTable
#ordinal(employ_datQ23.aEthnicity$CatOutcome, employ_datQ23.aEthnicity$EthnicityCleaned, employ_datQ23.aEthnicity)
#prep <- analysisPrep(employ_datQ23.aEthnicity$CatOutcome, employ_datQ23.aEthnicity$EthnicityCleaned, employ_datQ23.aEthnicity)
#analysis <- polr(employ_datQ23.aEthnicity$CatOutcome ~ employ_datQ23.aEthnicity$EthnicityCleaned, data=employ_datQ23.aEthnicity, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across FirstGen
"First Generation to go to University"
employ_datQ23.aFirstGen<-multidatClean(Q23.a, FirstGen, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q23.a + FirstGen, data = employ_datQ23.aFirstGen)
conTable
detach(dat_long)
#employ_datQ23.aFirstGen$FirstGen<-factor(employ_datQ23.aFirstGen$FirstGen)
#employ_datQ23.aFirstGen<-NotsureordinaldatClean(employ_datQ23.aFirstGen$Q23.a, employ_datQ23.aFirstGen)
#ordinal(employ_datQ23.aFirstGen$CatOutcome, employ_datQ23.aFirstGen$FirstGen, employ_datQ23.aFirstGen)
#prep <- analysisPrep(employ_datQ23.aFirstGen$CatOutcome, employ_datQ23.aFirstGen$FirstGen, employ_datQ23.aFirstGen)
#analysis <- polr(employ_datQ23.aFirstGen$CatOutcome ~ employ_datQ23.aFirstGen$FirstGen, data=employ_datQ23.aFirstGen, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Gender
"Gender"
employ_datQ23.aGender<-multidatClean(Q23.a, Gender, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q23.a + Gender, data = employ_datQ23.aGender)
conTable
#ordinal(employ_datQ23.aGender$CatOutcome, employ_datQ23.aGender$Gender, employ_datQ23.aGender)
#prep <- analysisPrep(employ_datQ23.aGender$CatOutcome, employ_datQ23.aGender$Gender, employ_datQ23.aGender)
#analysis <- polr(employ_datQ23.aGender$CatOutcome ~ employ_datQ23.aGender$Gender, data=employ_datQ23.aGender, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
### Analysis for Edinburgh people comparing the answer across Sexuality
"Sexuality"
employ_datQ23.aSexuality<-multidatClean(Q23.a, Sexuality, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q23.a + Sexuality, data = employ_datQ23.aSexuality)
conTable
#ordinal(employ_datQ23.aSexuality$CatOutcome, employ_datQ23.aSexuality$Sexuality, employ_datQ23.aSexuality)
#prep <- analysisPrep(employ_datQ23.aSexuality$CatOutcome, employ_datQ23.aSexuality$Sexuality, employ_datQ23.aSexuality)
#analysis <- polr(employ_datQ23.aSexuality$CatOutcome ~ employ_datQ23.aSexuality$Sexuality, data=employ_datQ23.aSexuality, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#Q23.a_OR_Table <- OR_Outcomes
#OR_Outcomes
#graph_prep (OR_Outcomes)

### Q24
"Status"
employ_datQ24<-multidatClean(Q24, Academic, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q24 + Academic, data = employ_datQ24)
conTable
detach(dat_long)
#employ_datQ24<-NotsureordinaldatClean(employ_datQ24$Q24, employ_datQ24)
#ordinal(employ_datQ24$CatOutcome, employ_datQ24$Academic, employ_datQ24)
##prep <- analysisPrep(employ_datQ24$CatOutcome, employ_datQ24$Academic, employ_datQ24)
##analysis <- polr(employ_datQ24$CatOutcome ~ employ_datQ24$Academic, data=employ_datQ24, Hess=TRUE)
##assumption<-brant(analysis)
##analysisSummary <- summary(analysis)
##ctable <- coef(summary(analysis))
##p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across College
"College"
employ_datQ24College<-multidatClean(Q24, Q3, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q24 + Q3, data = employ_datQ24College)
conTable
detach(dat_long)
#employ_datQ24College$Q3[(employ_datQ24College$Q3 == "Research Professional Staff")]="Other"
#employ_datQ24College$Q3<- factor(employ_datQ24College$Q3)
#employ_datQ24College<-NotsureordinaldatClean(employ_datQ24College$Q24, employ_datQ24College)
#ordinal(employ_datQ24College$CatOutcome, employ_datQ24College$Q3, employ_datQ24College)
#prep <- analysisPrep(employ_datQ24College$CatOutcome, employ_datQ24College$Q3, employ_datQ24College)
#analysis <- polr(employ_datQ24College$CatOutcome ~ employ_datQ24College$Q3, data=employ_datQ24College, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Carer- Yes/No
"Caring Responsibilities"
employ_datQ24Carer<-multidatClean(Q24, Carer, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q24 + Carer, data = employ_datQ24Carer)
conTable
detach(dat_long)
#employ_datQ24Carer$Carer<- factor(employ_datQ24Carer$Carer)
#employ_datQ24Carer<-NotsureordinaldatClean(employ_datQ24Carer$Q24, employ_datQ24Carer)
#ordinal(employ_datQ24Carer$CatOutcome, employ_datQ24Carer$Carer, employ_datQ24Carer)
#prep <- analysisPrep(employ_datQ24Carer$CatOutcome, employ_datQ24Carer$Carer, employ_datQ24Carer)
#analysis <- polr(employ_datQ24Carer$CatOutcome ~ employ_datQ24Carer$Carer, data=employ_datQ24Carer, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Disability
"Disability"
employ_datQ24Disability<-multidatClean(Q24, Disability, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q24 + Disability, data = employ_datQ24Disability)
conTable
detach(dat_long)
#employ_datQ24Disability$Disability<- factor(employ_datQ24Disability$Disability)
#employ_datQ24Disability<-NotsureordinaldatClean(employ_datQ24Disability$Q24, employ_datQ24Disability)
#conTable <- xtabs(~Q24 + Disability, data = employ_datQ24Disability)
#ordinal(employ_datQ24Disability$CatOutcome, employ_datQ24Disability$Disability, employ_datQ24Disability)
#prep <- analysisPrep(employ_datQ24Disability$CatOutcome, employ_datQ24Disability$Disability, employ_datQ24Disability)
#analysis <- polr(employ_datQ24Disability$CatOutcome ~ employ_datQ24Disability$Disability, data=employ_datQ24Disability, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Ethnicity 
"Ethnicity"
employ_datQ24Ethnicity<-multidatClean(Q24, EthnicityCleaned, UniqueResponseNumber, employ_dat)
detach(dat_long)
#employ_datQ24Ethnicity$Ethnicity<- factor(employ_datQ24Ethnicity$EthnicityCleaned)
#employ_datQ24Ethnicity<-NotsureordinaldatClean(employ_datQ24Ethnicity$Q24, employ_datQ24Ethnicity)
conTable <- xtabs(~Q24 + EthnicityCleaned, data = employ_datQ24Ethnicity)
conTable
#ordinal(employ_datQ24Ethnicity$CatOutcome, employ_datQ24Ethnicity$EthnicityCleaned, employ_datQ24Ethnicity)
#prep <- analysisPrep(employ_datQ24Ethnicity$CatOutcome, employ_datQ24Ethnicity$EthnicityCleaned, employ_datQ24Ethnicity)
#analysis <- polr(employ_datQ24Ethnicity$CatOutcome ~ employ_datQ24Ethnicity$EthnicityCleaned, data=employ_datQ24Ethnicity, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across FirstGen
"First Generation to go to University"
employ_datQ24FirstGen<-multidatClean(Q24, FirstGen, UniqueResponseNumber, employ_dat)
conTable <- xtabs(~Q24 + FirstGen, data = employ_datQ24FirstGen)
conTable
detach(dat_long)
#employ_datQ24FirstGen$FirstGen<-factor(employ_datQ24FirstGen$FirstGen)
#employ_datQ24FirstGen<-NotsureordinaldatClean(employ_datQ24FirstGen$Q24, employ_datQ24FirstGen)
#ordinal(employ_datQ24FirstGen$CatOutcome, employ_datQ24FirstGen$FirstGen, employ_datQ24FirstGen)
#prep <- analysisPrep(employ_datQ24FirstGen$CatOutcome, employ_datQ24FirstGen$FirstGen, employ_datQ24FirstGen)
#analysis <- polr(employ_datQ24FirstGen$CatOutcome ~ employ_datQ24FirstGen$FirstGen, data=employ_datQ24FirstGen, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
#### Analysis for Edinburgh people comparing the answer across Gender
"Gender"
employ_datQ24Gender<-multidatClean(Q24, Gender, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q24 + Gender, data = employ_datQ24Gender)
conTable
#ordinal(employ_datQ24Gender$CatOutcome, employ_datQ24Gender$Gender, employ_datQ24Gender)
#prep <- analysisPrep(employ_datQ24Gender$CatOutcome, employ_datQ24Gender$Gender, employ_datQ24Gender)
#analysis <- polr(employ_datQ24Gender$CatOutcome ~ employ_datQ24Gender$Gender, data=employ_datQ24Gender, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
...
### Analysis for Edinburgh people comparing the answer across Sexuality
"Sexuality"
employ_datQ24Sexuality<-multidatClean(Q24, Sexuality, UniqueResponseNumber, employ_dat)
detach(dat_long)
conTable <- xtabs(~Q24 + Sexuality, data = employ_datQ24Sexuality)
conTable
#ordinal(employ_datQ24Sexuality$CatOutcome, employ_datQ24Sexuality$Sexuality, employ_datQ24Sexuality)
#prep <- analysisPrep(employ_datQ24Sexuality$CatOutcome, employ_datQ24Sexuality$Sexuality, employ_datQ24Sexuality)
#analysis <- polr(employ_datQ24Sexuality$CatOutcome ~ employ_datQ24Sexuality$Sexuality, data=employ_datQ24Sexuality, Hess=TRUE)
#assumption<-brant(analysis)
#analysisSummary <- summary(analysis)
#ctable <- coef(summary(analysis))
#p <- pnorm(abs(ctable[, "t value"]), lower.tail = FALSE) * 2
